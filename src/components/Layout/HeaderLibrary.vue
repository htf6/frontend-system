  ...
  <header class="header">
    <div class="header-left">
      ...
      <div class="breadcrumb">
        <span v-if="currentIcon" class="page-icon">
...
import {
  Menu, ArrowDown, User, Lock, SwitchButton,
  Setting, Bell, Message, OfficeBuilding, Document,
  Connection, Coin
...
const currentIcon = computed(() => routeIconMap[route.meta?.icon] || null)
